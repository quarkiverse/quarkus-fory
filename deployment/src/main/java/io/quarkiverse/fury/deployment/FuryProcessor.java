...
class FuryProcessor {
    ...
    public void findSerializableClasses(CombinedIndexBuildItem combinedIndex,
        ...
        combinedIndex.getIndex().getAnnotations(FURY_SERIALIZATION)
                .stream()
    ...
    public void registerClasses(FuryBuildItem fury, List<FurySerializerBuildItem> classes, FuryRecorder recorder) {
    ...
    @BuildStep
    @Record(ExecutionTime.STATIC_INIT)
    public FuryBuildItem setup(FuryBuildTimeConfig config, BeanContainerBuildItem beanContainer, FuryRecorder recorder) {
